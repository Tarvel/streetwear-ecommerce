    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drop', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='productapp.drop')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='additional_images', to='productapp.product')),
            ],
        ),
    ]
